...
Write-DhcpDebug -Message 'Analyzing DHCP lease expiry' -Data ([ordered]@{ FileName = 'dhcp-lease-expiry.json' })

$payload = Get-DhcpCollectorPayload -Context $Context -FileName 'dhcp-lease-expiry.json'
